...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->prefix('products', function($routes){
        $routes->connect('/edit/:id', ['controller' => 'Products', 'action' => 'edit', 'edit']);
        $routes->connect('/delete/:id', ['controller' => 'Products', 'action' => 'delete', 'delete']);
    });
    
    $routes->connect('callsp', ['controller' => 'Products', 'action' => 'callSP', 'callSP']);
